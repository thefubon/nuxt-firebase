    ...
    <form v-if="!registrationPassed" @submit.prevent="checkForm">
      ...
      <div class="my-6">
        <button
          type="submit"
          :disabled="loading"
          class="visually-hidden inline-flex items-center px-4 py-3 bg-indigo-500 text-white rounded d-flex align-items-center"
        >
          <div v-if="loading" role="status">
            <svg
              class="visually-hidden Registration animate-spin -ml-1 mr-3 h-5 w-5 text-white"
