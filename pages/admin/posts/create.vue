...
export default {
  ...
  data: () => ({
    ...
    categories: [],
    body: [
      // { id: 1, component: "Input", value: null, label: "Label Input" },
      // { id: 2, component: "Textarea", value: null, label: "Label Textarea" },
      // { id: 3, component: "SingleImage", value: null, label: "Label Image" },
      // {
      //   id: 4,
